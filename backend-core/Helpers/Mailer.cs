...
namespace backend_core
{
    public class Mailer
    {
        ...
        private const string EMAIL_TEMPLATE = "<html><head><meta http-equiv='Content-Type' content='text/html; charset=UTF-8' /><meta name='viewport' content='width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0' /><link href='https://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet'><title>Monoid</title><style>body{font-family:'Open Sans',sans-serif}td[class='text']{color:#000;font-size:13px}html,body{margin:0;padding:0}table{border-collapse:collapse}tr[class='border-color']{border-color:#F1C232!important}tr[class='banner']{background-color:#FFF;height:50px;width:100%}td[class='titlebanner']{color:#000;font-size:24px;font-weight:700;vertical-align:middle}td[class='banner-logo']{vertical-align:middle}td[class='riskbanner']{background-color:*|RISKCOLOR|*;width:50px;position:relative}td[class='riskbanner']:after{content:'';position:absolute;left:0;bottom:0;width:0;height:0;border-bottom:13px solid #FFF;border-left:25px solid transparent;border-right:25px solid transparent}td[class='main-spacing']{padding-left:30px;padding-right:30px;padding-top:20px;padding-bottom:10px}td[class='content-spacing']{padding-left:30px;padding-right:30px;padding-top:10px;padding-bottom:20px}</style></head><body bgcolor='#f5f5f7'><table width='600' cellspacing='0' cellpadding='0' border='0' bgcolor='#ffffff' align='center'><tbody><tr class='border-color' style='border-top: 4px solid;'><td class='main-spacing'><table><tbody><tr class='banner'><td class='banner-logo'><img src='https://i.imgur.com/PcbgYeE.png' width='100' /></td><td width='27'></td><td class='titlebanner' width='393'>*|TITLE|*</td><td class='riskbanner' width='50'></td><td width='20'></td></tr></tbody></table></td></tr><tr><td class='content-spacing'><table width='540' align='left'><tbody><tr><td class='text'>Dear *|RECIPIENT|*,<br /><br /></td></tr><tr><td class='text'>*|BODY|*</td></tr><tr><td class='text'><br />Best regards,<br />Monoid Inc<br /><br /></td></tr></tbody></table></td></tr><tr class='border-color' style='border-bottom: 4px solid;'><td></td></tr></tbody></table></body></html>";
        ...
        public bool SendEmail(string body, string subject, string title, string[] recipient)
        {
        ...
        public void SendSystemNotification(Settings settings, string message, Risk type, string title)
        {
            ...
            SendEmail(message, subject, title, settings.NotificationRecipients);
        }
